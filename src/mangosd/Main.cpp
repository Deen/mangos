...
extern int main(int argc, char **argv)
{
    ...
    sLog.outTitle( "MMMMMMMM  MMMM    MM       MMM       MM ");
    sLog.outTitle( "MM        MM  MM  MM      MM MM      MM ");
    sLog.outTitle( "MM        MM   MM  MM     MM MM     MM ");
    sLog.outTitle( "MM        MM    MM MM     MM MM     MM ");
    sLog.outTitle( "MMMMMMMM  MM    MM  MM   MM   MM   MM ");
    sLog.outTitle( "      MM  MM    MM  MM   MM   MM   MM ");
    sLog.outTitle( "      MM  MM   MM    MM MM     MM MM ");
    sLog.outTitle( "      MM  MM  MM     MM MM     MM MM ");
    sLog.outTitle( "MMMMMMMM  MMMM        MMM       MMM - Core ");
    sLog.outTitle( "SDW core - Forked MaNGOS");
    sLog.outTitle( "MaNGOS core http://getmangos.com\n\n");
